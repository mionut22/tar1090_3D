...
GITREPO=$(mktemp -d)
THIS_DIR=$(dirname $0)
echo "Cloning route repo ..."
git clone --depth=1 https://github.com/vradarserver/standing-data $GITREPO
echo "Downloading Airlines Names ..."
#wget -q -O $THIS_DIR/airlines.csv https://raw.githubusercontent.com/tugraz-isds/datasets/refs/heads/master/airports_airlines/Airlines.csv
...
mv $GITREPO/airlines/schema-01/airlines.csv $THIS_DIR/airlines.csv
echo "YR,Romanian Civil Aircraft,,YR,," >> $THIS_DIR/airlines.csv
echo "Clean up ..."
