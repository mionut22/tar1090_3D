...
let PageName = "AMI ADSB Receiver";
...
let routeApiUrl = "http://planes.ami:8080/route";
...
let tableInView = true; // only show aircraft in current view (V button)

let audio_url = ["", "", "", "", "", ""];
// let audio_url = [["https://www.liveatc.net/hlisten.php?mount=lrbv2&icao=lrbv", "Brasov Tower"], ["https://www.liveatc.net/hlisten.php?mount=lrop&icao=lrop", "Otopeni Tower"], ["", ""], ["", ""], ["", ""], ["", ""]]; // show html5 audio player for these URLs
...
let DefaultCenterLat = 45.75;
let DefaultCenterLon = 25.64;
